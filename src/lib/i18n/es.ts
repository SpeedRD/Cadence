...
export const es = {
  ...
  inbox: {
    ...
    emptyDescription:
      "Los recurrentes se están registrando, tus planes de Cuotas siguen encajando, no apareció ningún patrón sin seguimiento y cada plan de meta va según su hoja de ruta.",
    ...
    goalTitle: (name: string) => `${name} va por detrás de su hoja de ruta`,
    goalBehindBy: "Por detrás",
    goalRoadmap: "Hoja de ruta este periodo",
    goalPlanned: "Planificado este periodo",
    goalPeriod: "Periodo",
